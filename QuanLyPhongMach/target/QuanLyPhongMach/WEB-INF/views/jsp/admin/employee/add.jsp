...
<div class="page-wrapper">
    <div class="content">
        ...
        <form:form modelAttribute="employee" action="/employee/add" enctype="multipart/form-data" method="post">
                ...
                <div class="col-lg-8 offset-lg-2">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><spring:message code="employee.add.label.last" /></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><spring:message code="employee.add.label.password" /></label>
                                    <form:password path="password" cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><spring:message code="employee.add.label.confirmPsw" /></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group gender-select">
                                    <label class="gen-label"><spring:message code="employee.add.label.gender" /></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><spring:message code="employee.add.label.phone" /> </label>
                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <label><spring:message code="employee.add.label.hometown" /></label>
