                    ...
                    <form>
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <c:if test="${medicine.tenThuoc == null}">
                                                <label><spring:message code="medicine.add.label.name" /></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <c:if test="${medicine.tenThuoc == null}">
                                        <label><spring:message code="medicine.add.label.des" /></label>
                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <c:if test="${medicine.tenThuoc == null}">
                                                <label><spring:message code="medicine.add.label.price" /></label>
                                                <form:input path="donGia" cssClass="form-control" />
                                            </c:if>
                                            <c:if test="${medicine.tenThuoc != null}">
                                                <label><spring:message code="medicine.add.label.price" /></label>
                                                <form:input path="donGia" cssClass="form-control" value="${medicine.donGia}" />
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <c:if test="${medicine.tenThuoc == null}">
                                        <label><spring:message code="medicine.add.label.unit" /></label>
